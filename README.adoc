= J-Voting
:oldgoupId: io.github.oliviercailloux.y2018
...
image:https://maven-badges.herokuapp.com/maven-central/{oldgroupId}/{artifactId}/badge.svg["Artifact on Maven Central", link="http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22{groupId}%22%20a%3A%22{artifactId}%22"]
image:http://www.javadoc.io/badge/{oldgroupId}/{artifactId}.svg["Javadocs", link="http://www.javadoc.io/doc/{groupId}/{artifactId}"]
